...
Я впервые начал свой путь в веб-разработке, создав скрипт для управления прайсами заказов. Пройдя первый курс по PHP, во время новогодних выходных я погрузился в творческий процесс и создал свою первую собственную CMS. Несмотря на то, что она скорее представляла из себя набор кривых и косых элементов, она функционировала и служила каталогом товаров с возможностью предварительного заказа продукции компании, в которой я тогда работал в качестве представителя.

[Ссылка на проект product-catalog](https://github.com/DenisUstinov/DenisUstinov/tree/2777440ce5651790fa9e283a0f08874d39622351/product-catalog)
...
Важно подчеркнуть, все что было до этого, больше напоминало метод «ТЫКА», чем осознанные действия.
