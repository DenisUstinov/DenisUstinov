...
### Универсальная CMS и Новостной Сайт "Global News", 2016 год
...
Проект не поддерживается. Некоторые функции, в целях безопасности, отключены.
* Ссылка на сайт: [product-catalog](https://global-news.denisustinov.name)
